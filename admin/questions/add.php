                                            ...
                                            <div class="card-body">
                                                ...
                                                <input type="hidden" name="action" value="admin/add-questions">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="question" name="question" placeholder="Enter Question type">
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group list-group-item">
                                                            <div class="type-1">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="options_answer[]" id="options_answer1" value="1">
                                                                    <input type="text" class="form-control" id="options1" name="options[]" placeholder="Enter option">
                                                                </div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="options_answer[]" id="options_answer2" value="2">
                                                                    <input type="text" class="form-control" id="options2" name="options[]" placeholder="Enter option">
                                                                </div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="options_answer[]" id="options_answer3" value="3">
                                                                    <input type="text" class="form-control" id="options3" name="options[]" placeholder="Enter option">
                                                                </div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="options_answer[]" id="options_answer4" value="4">
                                                                    <input type="text" class="form-control" id="options4" name="options[]" placeholder="Enter option">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="type-2 d-none">
                                                                <div class="form-check">
                                                                    ...
                                                                    <input type="text" class="form-control" id="options1" name="options[]" placeholder="Enter option" disabled>
                                                                </div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox" name="options_answer[]" id="options_answer_checkbox2" value="2" disabled>
                                                                    <input type="text" class="form-control" id="options2" name="options[]" placeholder="Enter option" disabled>
                                                                </div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox" name="options_answer[]" id="options_answer_checkbox3" value="3" disabled>
                                                                    <input type="text" class="form-control" id="options3" name="options[]" placeholder="Enter option" disabled>
                                                                </div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox" name="options_answer[]" id="options_answer_checkbox4" value="4" disabled>
                                                                    <input type="text" class="form-control" id="options4" name="options[]" placeholder="Enter option" disabled>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="type-3 d-none">
                                                                <div class="form-check">
                                                                    ...
                                                                    <input type="hidden" class="form-control" id="optionstrue" name="options[]" placeholder="Enter option" value="True" disabled>
                                                                </div>
                                                                <div class="form-check">
                                                                    ...
                                                                    <input type="hidden" class="form-control" id="optionsfalse" name="options[]" placeholder="Enter option" value="False" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <button type="submit" class="btn btn-primary me-2 add-question">Submit</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
